...
export const BRANDS = [
  ...
  },
  {
    name: "Rongta",
    origin: "Global",
    category: "Balanzas Etiquetadoras, POS e Inteligencia Artificial",
    highlight: "Equipos POS con IA para reconocimiento visual de productos y balanzas de tickets",
    logo: "/images/marcas/rongta.svg",
  },
  {
    name: "Techfood",
    origin: "Global",
    category: "Maquinaria Cárnica, Empaque al Vacío y Plataformas",
    highlight: "Molinos de alta potencia, empacadoras al vacío y pesaje sanitario en acero inoxidable",
    logo: "/images/marcas/techfood.svg",
  },
  {
    name: "ABM",
    origin: "Italia",
    category: "Rebanadoras Profesionales de Precisión",
    highlight: "Ingeniería y corte italiano de alta precisión para charcutería y gastronomía",
    logo: "/images/marcas/abm.svg",
  },
  {
    name: "Lucky",
    origin: "Global",
    category: "Cuchillería Profesional y Herramientas Sanitarias",
    highlight: "Acero alemán 1.4116 con certificación sanitaria internacional NSF",
    logo: "/images/marcas/lucky.svg",
  },
  {
    name: "Dialka",
    origin: "Venezuela",
