...
export default function SoftwarePage() {
  return (
    <>
      ...
      <section className="bg-slate-950 py-12 md:py-16 text-white border-b border-slate-800">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-16">
            {SOFTWARE_SYSTEMS.map((system, index) => (
              <div
                key={system.name}
                className="card-hover group bg-white border border-slate-200 hover:border-red-200 rounded-2xl p-8 flex flex-col justify-between shadow-xs hover:shadow-md transition-all duration-200"
              >
                <div>
                  <div className="flex items-center justify-between mb-5">
                    <div className="w-12 h-12 rounded-xl bg-slate-50 border border-slate-100 group-hover:bg-red-50 group-hover:border-red-100 flex items-center justify-center transition-colors">
                      <Monitor size={20} className="text-slate-700 group-hover:text-[#991b1b] transition-colors" />
                    </div>
                    <span className="text-xs font-bold text-[#991b1b] bg-red-50 border border-red-200/80 px-2.5 py-1 rounded-full uppercase tracking-wider">
                      Sistema 0{index + 1}
                    </span>
                  </div>

                  <h3 className="text-lg font-bold text-slate-900 mb-3 group-hover:text-[#991b1b] transition-colors leading-snug">
                    {system.name}
                  </h3>
          ...
          <div className="bg-slate-50/80 rounded-2xl border border-slate-200 p-8 sm:p-10 shadow-xs">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {TECH_FEATURES.map((feat) => {
                ...
                return (
                  <div key={feat.title} className="bg-white border border-slate-200/80 rounded-xl p-5 shadow-2xs">
                    <div className="w-10 h-10 rounded-lg bg-red-50 border border-red-100 flex items-center justify-center mb-3">
                      <Icon size={18} className="text-[#991b1b]" />
                    </div>
