      ...
      <div className="bg-slate-50/70 py-14 md:py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-12 gap-10">
            {/* Columna Izquierda: Información de Sedes (7 cols) */}
            <div className="lg:col-span-7 space-y-8">
              {CONTACT.headquarters.map((hq) => (
                <div
                  key={hq.city}
                  className="card-hover bg-white border border-slate-200 rounded-2xl p-7 sm:p-8 shadow-xs"
                >
              ...
              <div className="card-hover bg-white border border-slate-200 rounded-2xl p-6 sm:p-7 shadow-xs">
                ...
                <div className="grid sm:grid-cols-2 gap-4 text-sm pt-3 border-t border-slate-100">
                  <button
                    onClick={() =>
