          ...
          <div className="grid lg:grid-cols-12 gap-10 items-center">
            ...
            <div className="lg:col-span-7">
              ...
              <p className="text-slate-600 max-w-2xl text-base sm:text-lg leading-relaxed mb-6">
                Soluciones flexibles de pesaje bajo modalidad de arrendamiento temporal. Básculas para control vehicular por eje (20T y 40T), plataformas ganaderas y básculas industriales con servicio técnico y calibración incluida en toda Venezuela.
              </p>
          ...
          <div className="bg-slate-50/80 rounded-2xl border border-slate-200 p-8 sm:p-10 shadow-xs">
            ...
            <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-6">
              {RENTAL_ADVANTAGES.map((adv) => {
                const Icon = adv.icon;
                return (
                  <div key={adv.title} className="bg-white border border-slate-200/80 rounded-xl p-5 shadow-2xs">
