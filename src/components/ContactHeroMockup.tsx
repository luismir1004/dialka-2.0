...
const SEDES_DATA = [
  {
    ...
    address: "Av. Los Próceres, San Bernardino, Qta. Los Juanes No. 46, Caracas",
  ...
  },
  {
    ...
    address: "Av. Intercomunal Turmero, C.C. Coche Aragua, PB Local 52, La Morita",
...
const LIGHTBOX_ITEM: LightboxItem = {
  ...
  subtitle: "Sedes Oficiales Caracas (San Bernardino) y Maracay (La Morita)",
  description:
  ...
  specs: [
    "Sede Principal Caracas: Av. Los Próceres, San Bernardino, Qta. Los Juanes · (0212) 381.18.23",
    "Sede Operativa Maracay: Av. Intercomunal Turmero, C.C. Coche Aragua, La Morita · (0243) 234.33.60",
