      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-10 md:py-12">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-10 items-start">
          ...
          <div className="lg:col-span-4 space-y-4">
            ...
            {/* Redes y enlaces sociales compactos */}
            <div className="flex items-center gap-2 pt-1">
              {CONTACT.socials.map((s) => (
                <a
                  ...
                  rel="noreferrer"
                  title={s.name}
                  className="w-7 h-7 rounded-lg bg-slate-800 hover:bg-[#991b1b] flex items-center justify-center transition-colors text-slate-400 hover:text-white"
                >
                  <ExternalLink size={12} />
                </a>
              ))}
              <span className="text-[11px] text-slate-500 ml-2">@balanzasdialka</span>
            </div>
          </div>
